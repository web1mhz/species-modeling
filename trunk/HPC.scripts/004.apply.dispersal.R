...
tfile = 'c:/users/jeremy/desktop/22864841.predictions.binary.csv.gz' #this is the binary data file
spp = 22864841
out.dir = 'c:/users/jeremy/desktop/'
...
#write out the projection data
write.csv(out,paste(out.dir,spp,'.prediction.area.csv',sep=''),row.names=FALSE)
